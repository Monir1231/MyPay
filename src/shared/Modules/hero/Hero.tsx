  ...
  return (
    <div className="w-full px-2 md:px-10 h-[90vh] md:flex items-center bg-hero-gradiant relative ">
      ...
      <div className="md:w-[50%] w-full relative z-10 md:pt-52 pt-36 ">
        <h1 className="lg:text-5xl md:text-4xl text-[30px] font-poppeins font-[700] md:leading-[70px]">
        ...
        <button className="w-[219px] h-[69px] rounded-full  border-2 border-[#42A3FF] mb-3 ">
